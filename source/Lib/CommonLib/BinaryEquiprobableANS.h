...
public:
    ...
    */
     ...
     */
    static void encode(uint8_t &currentState, const uint8_t symbol, BitstreamWriter &writer) {
        ...
        currentState = (currentState * 2) + symbol;
    }
     ...
     */
    static uint8_t decode(uint8_t &currentState, BitstreamReader &reader) {
